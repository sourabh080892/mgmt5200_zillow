...
phone <- phone[phone$TalkTimeMinutes >= 1 & phone$TalkTimeMinutes <= 1000,]
```
...
base <- inner_join(agent_leads, phone, by = c("REAgentID", "SalesRepID"))
base <- left_join(base, sales_meet, by = c("SalesRepID", "REAgentID"))
base <- left_join(base, agentid_acq_dates, by = "REAgentID")
