...
finaldf$Leadcount <- as.numeric(finaldf$Leadcount)
finaldf$Phonecount <- as.numeric(finaldf$Phonecount)
finaldf$Meetingcount <- as.numeric(finaldf$Meetingcount)
finaldf$Acquiredcount <- as.numeric(finaldf$Acquiredcount)
...
finaldf_ft$Leadcount <- as.numeric(finaldf_ft$Leadcount)
finaldf_ft$Phonecount <- as.numeric(finaldf_ft$Phonecount)
finaldf_ft$Meetingcount <- as.numeric(finaldf_ft$Meetingcount)
finaldf_ft$Acquiredcount <- as.numeric(finaldf_ft$Acquiredcount)


write.csv(finaldf_ft, file = "FinalData_ft.csv")
```
